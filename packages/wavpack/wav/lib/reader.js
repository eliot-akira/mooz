...
let Parser = require('stream-parser')
let Transform = require('readable-stream/transform')
let debug = require('debug')('wave:reader')
...
Reader.prototype._onRiffID = function (chunk) {
  ...
  let id = this.riffId = chunk.toString('ascii')
  if (id === 'RIFF') {
...
Reader.prototype._onSubchunk1ID = function (chunk) {
  ...
  let subchunk1ID = chunk.toString('ascii')
...
Reader.prototype._onJUNK = function (chunk) {
  let junkSize = chunk['readUInt32' + this.endianness](0)
...
Reader.prototype._onSubchunk2ID = function (chunk) {
  ...
  let subchunk2ID = chunk.toString('ascii')
...
Reader.prototype._onFactChunkSize = function (chunk) {
  ...
  let chunkDataSize = chunk['readUInt32' + this.endianness](0)
...
Reader.prototype._onFactChunkData = function (chunk) {
  ...
  let numSamples = chunk['readUInt32' + this.endianness](0)
