...
module.exports = (function(){
  ...
  Tone.Context.prototype.getConstant = function(val){
    if (this._constants[val]){
      ...
      let buffer = this._context.createBuffer(1, 128, this._context.sampleRate)
  ...
  Object.defineProperty(Tone.Context.prototype, "lag", {
    get : function(){
      let diff = this._computedUpdateInterval - this._updateInterval
  ...
  function shimConnect(){
    ...
    let nativeConnect = AudioNode.prototype.connect
    let nativeDisconnect = AudioNode.prototype.disconnect

    //replace the old connect method
    function toneConnect(B, outNum, inNum){
      if (B.input){
        if (Array.isArray(B.input)){
          if (Tone.prototype.isUndef(inNum)) inNum = 0
        ...
        try {
          if (B instanceof AudioNode){
            ...
            if (Array.isArray(B)) {
              if (Tone.prototype.isUndef(inNum)) inNum = 0
              const dest = B[inNum].input ? B[inNum].input : B[inNum]

              //console.log('nativeConnect.call(this, B[inNum], outNum)', this, dest, outNum)
              if (!Tone.prototype.isUndef(outNum)) {
                nativeConnect.call(this, dest, outNum)
              } else {
